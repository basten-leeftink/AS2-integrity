package asl
 ...
 class tomZ  (coms: AgentCommunicationLayer = new  DefaultCommunications,
         ...
         message match {
            case SubGoalMessage(_,_,r) =>
               message.goal match {
                   ...
                   case tomZ.this.adopt_test_benevolent_2 =>
                     tomZ.this.adopt_test_benevolent_2.execute(message.params.asInstanceOf[Parameters])

                   case tomZ.this.adopt_test_valueprofile_3 =>
                     tomZ.this.adopt_test_valueprofile_3.execute(message.params.asInstanceOf[Parameters])
 ...
 class Agent extends IAgent {
         ...
         override def agent_type: String = "tomZ"
         ...
         def initBeliefs()(implicit executionContext: ExecutionContext) = List[StructTerm](
                     StructTerm("myvalueprofile",Seq[GenericTerm](IntTerm(8),IntTerm(2)))
           ,
            StructTerm("inplan",Seq[GenericTerm](StructTerm("plan2",Seq[GenericTerm]()),StructTerm("wine",Seq[GenericTerm]())))
           ,
            StructTerm("inplan",Seq[GenericTerm](StructTerm("plan1",Seq[GenericTerm]()),StructTerm("party",Seq[GenericTerm]())))
           ,
           ...
           ,
            StructTerm("phi",Seq[GenericTerm](StructTerm("comfort",Seq[GenericTerm]()),StructTerm("plan1",Seq[GenericTerm]()),DoubleTerm(0.5)))
           ,
            StructTerm("phi",Seq[GenericTerm](StructTerm("fun",Seq[GenericTerm]()),StructTerm("plan2",Seq[GenericTerm]()),DoubleTerm(0.1)))
           ,
            StructTerm("phi",Seq[GenericTerm](StructTerm("fun",Seq[GenericTerm]()),StructTerm("plan1",Seq[GenericTerm]()),DoubleTerm(0.9)))
           ,
            StructTerm("benevolence",Seq[GenericTerm](StructTerm("comfort",Seq[GenericTerm]()),DoubleTerm(0.4)))
           ,
            StructTerm("benevolence",Seq[GenericTerm](StructTerm("fun",Seq[GenericTerm]()),DoubleTerm(0.5)))
           ,
         ...
         vars("Parent").bind_to(StringTerm(executionContext.parent.name))
             ...
             executionContext.src.asInstanceOf[AkkaMessageSource].address() ! IntentionErrorMessage(NoApplicablePlanMessage(),AkkaMessageSource(executionContext.agent.self))
                      ...
                      def plan0(vars: VarMap)(implicit executionContext: ExecutionContext): Unit = {
                                          ...
                                          PrimitiveAction.execute(PrimitiveAction.Parameters(() => coms.inform(StructTerm("agentX",Seq[GenericTerm]()),StructTerm("benevolent",Seq[GenericTerm](StructTerm("agentZ",Seq[GenericTerm]()),vars("X"))))))
...
object tomZ_companion { 
   def create() = new tomZ().agentBuilder 
   def create(in_coms : AgentCommunicationLayer) = new tomZ(coms = in_coms).agentBuilder 
   def create(in_beliefBaseFactory: IBeliefBaseFactory) = new tomZ(beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
   def create(in_coms : AgentCommunicationLayer, in_beliefBaseFactory: IBeliefBaseFactory) = new tomZ(coms = in_coms, beliefBaseFactory = in_beliefBaseFactory).agentBuilder 
} 
